...
public class BenefitController {
    ...
    public ResponseEntity<BenefitReturnDto> saveBenefit(@RequestBody @Valid BenefitDto dto, Principal connectedUser) {
        BenefitReturnDto benefit = benefitService.save(dto, connectedUser.getName());
    ...
    public ResponseEntity<BenefitReturnDto> getBenefit(@PathVariable @NotNull Integer id) {
        BenefitReturnDto benefit = benefitService.findById(id);
    ...
    public ResponseEntity<List<BenefitReturnDto>> getAllBenefitsForOrganisations(@NotNull Integer organisationId) {
        List<BenefitReturnDto> organisations = benefitService.findAllBenefitsForOrganisation(organisationId);
